...
router.post("/createUser", (req, res) => {
    ...
    const nuevoUsuario =
    {
        ...
        correo: "aylin.esteban@gmail.com"
    }
    res.json({
        status: 200,
...
router.put("/updateUser", (req, res) => {
    console.log("Se ha solicitado la actualización de los datos del usuario, siendo PUT una actualización completa.")
    ...
    {
        nombre: "Luis Mejia Tecorralco",
        correo: "luis.mejia@gmail.com"
    }
    res.json({
        status: 200,
